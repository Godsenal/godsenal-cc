...
plugins/
  base/
    ...
    skills/                        ← Skills (preferred — commands have been merged into skills per Claude Code docs)
      ...
      monitor/
        SKILL.md                   ← monitor skill: subscribe to PR, handle CI / reviews / safe conflicts until merge; runs polish before each non-trivial auto-fix commit
      pr-verify/
...
- **gbase**: Core productivity tools. Two commands and four skills:
